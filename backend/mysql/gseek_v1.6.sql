...
CREATE TABLE `good_cover_pic` (
  `good_id` int NOT NULL COMMENT '商品id',
  `cover_picture_id` int NOT NULL COMMENT '封面图片id',
  PRIMARY KEY (`good_id`,`cover_picture_id`)
...
CREATE TABLE `good_detail_pic` (
  `good_id` int NOT NULL COMMENT '商品id',
  `detail_picture_id` int NOT NULL COMMENT '图片id',
  PRIMARY KEY (`good_id`,`detail_picture_id`)
...
CREATE TABLE `offerprice` (
  ...
  `seller_id` int NOT NULL COMMENT '售卖着id',
  `bid` int NOT NULL COMMENT '出价',
  `good_id` int NOT NULL COMMENT '商品id',
  `offer_time` date NOT NULL COMMENT '出价时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `offerprice` */
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='记录图片id与对应url';
