...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gseek` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ ;

USE `gseek`;
/*Table structure for table `good_checked` */

CREATE TABLE `good_checked` (
...
/*Data for the table `good_checked` */
...
DROP TABLE IF EXISTS `appeal_buyer_to_seller`;
...
DROP TABLE IF EXISTS `appeal_seller_to_buyer`;
...
CREATE TABLE `appeal_seller_to_buyer` (
  ...
  `admin_id` int DEFAULT NULL COMMENT '审核管理员id',
  `appeal_result` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审核结果',
  `my_id` int DEFAULT NULL COMMENT '申诉者id',
  PRIMARY KEY (`appeal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `bill` (
  ...
  `state` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '待支付' COMMENT '订单状态',
  `state_modified_time` bigint DEFAULT '0' COMMENT '订单状态修改时间',
  PRIMARY KEY (`bill_id`),
  UNIQUE KEY `good_id` (`good_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单基本信息';

/*Data for the table `bill` */

insert  into `bill`(`bill_id`,`good_id`,`create_time`,`seller_id`,`buyer_id`,`state`,`state_modified_time`) values (3,1,21,1,2,'已支付',112);
...
CREATE TABLE `blacklist` (
  ...
  `provePic` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '举报图片',
...
CREATE TABLE `bought_good` (
  ...
  `buyer_id` int NOT NULL COMMENT '购买人id',
  PRIMARY KEY (`good_id`)
...
insert  into `good`(`good_id`,`good_name`,`account`,`account_password`,`good_text`,`own_user_name`,`own_user_id`,`good_price`,`create_time`,`modified_time`,`sold`,`type_tag_id`,`type_tag_name`) values (1,'test','testAccount','testAccountPassword','testText','testUser',1,'0.00',1234567891234,1234567891234,0,2,'test1');
...
insert  into `good_cover_pic`(`good_id`,`cover_picture_url`) values (1,'4'),(1,'5'),(1,'/test/path1'),(1,'/test/path2'),(1,'/test/path3');
...
insert  into `good_detail_pic`(`good_id`,`detail_picture_url`) values (1,'1'),(1,'2'),(1,'3');
...
insert  into `good_tag`(`good_id`,`tag_id`) values (1,2),(2,4);
...
insert  into `money`(`user_id`,`money`,`frozen`) values (1,'0.00',0),(2,'0.00',0);
...
insert  into `offer_price`(`bidder_id`,`seller_id`,`offer_price`,`good_id`,`offer_time`) values (1,2,'33.30',1,1),(1,1,'2.00',1,1212121);
...
insert  into `picture（弃用）`(`picture_id`,`picture_url`) values (1,'/test/1'),(2,'/test/2'),(3,'/test/3'),(4,'/test/4'),(5,'/test/5');

/*Table structure for table `recharge_withdraw` */
...
CREATE TABLE `recharge_withdraw` (
  ...
  `type` varchar(20) NOT NULL COMMENT '操作类型：recharge/withdraw',
  `rw_id` varchar(64) NOT NULL COMMENT '记录id',
  PRIMARY KEY (`rw_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='充值提现记录表';

/*Data for the table `recharge_withdraw` */
...
insert  into `tag`(`tag_id`,`tag_text`,`click`) values (2,'text1',0),(3,'text2',0),(4,'text3',0),(13,'aaa',0),(14,'bbb',0),(15,'1',0);
...
insert  into `user_identification`(`user_id`,`id_number`,`certified`,`modified_time`) values (1,'000000000000000000',0,1683043875814),(2,'000000000000000000',0,16830431235814);
...
insert  into `user_information`(`user_id`,`email`,`profile_photo`) values (1,'2967306689@qq.com','/imgs/profile_photos/default.jpg'),(2,'2967306689@qq.com','/imgs/profile_photos/default.jpg');
...
insert  into `user_password`(`user_id`,`user_name`,`password`,`salt`) values (1,'user1','user1','397924423F4528482B4D6251655468576D5A7134743777217A25432A46294A40'),(2,'user2','user2','397924423F4528482B4D6251655468576D5A7134743777217A25432A46294A40');
